...
with st.sidebar:
    ...
    st.page_link("dashboard.py", label="🕒 Driver Stint Planner", disabled=True)
    st.page_link("fuel.py", label="⛽ Fuel Strategy (Coming Soon)")
    st.page_link("notes.py", label="🗒 Track Notes (Coming Soon)")
    st.divider()
...
# ======================
# Timezone Conversion & Time Block Calculation
# ======================
tz_map = {
    "EST": "US/Eastern",
    "CST": "US/Central",
...
# Build table: driver rows, time columns
